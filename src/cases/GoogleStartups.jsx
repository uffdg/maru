...
const caseData = casesData['google-startups'];
      ...
      <section className="px-6 md:px-20 pb-24">
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8 bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-pink-50">
          ...
          <div className="space-y-2 border-l-2 border-gray-100 pl-6">
            ...
            <p className="font-bold text-gray-900 text-sm">{meta.program}</p>
          </div>
          <div className="space-y-2 border-l-2 border-gray-100 pl-6">
            <p className="text-[10px] font-bold uppercase text-gray-400">Years</p>
            <p className="font-bold text-gray-900 text-sm">{meta.years}</p>
          </div>
        </div>
      </section>
